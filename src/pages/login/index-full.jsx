...
// In development mode, form data is automatically populated
const formValues = {
    account: 'admin',
    password: '123456',
    imageCode: '0000',
...
export default config({
    ...
    const handleSendMessage = useCallback(() => {
        // return true or promise.resolve(true) The countdown starts and the button is not clickable Return to other non-countdowns
        return true;
    }, []);
        ...
        (values) => {
            ...
            login
                ...
                .catch((err) => {
                    ...
                    // You can refresh the image verification code
                ...
                <Form form={form} name="login" onFinish={handleSubmit}>
                    ...
                    <div className={formItemClass}>
                        <FormItem
                            ...
                            ref={imageCodeRef}
                            rules={[{required: true, message: 'Please enter the image verification code！'}]}
                        />
                    </div>
                    <div className={formItemClass}>
                        <FormItem
